...
function contactpage_handler($atts, $content = null)
{
    /**
    ...
    if (isset($_GET['contactSubmit'])) {
        ...
        <div class="span9 blog1_post contacts-page" id="blog_full_content">
            ...
            if ($a['gmap'] == 1):
                ...
                $query = get_posts(
                    array(
                        'meta_value' => '', 'post_type' => 'sf-store-locations'
                    )
                );
...
function wpt_events_location()
{
    ...
    $states = array("Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa",
