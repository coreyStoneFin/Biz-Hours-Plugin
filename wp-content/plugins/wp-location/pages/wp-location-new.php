<?php
/**
 * New Location Administration Screen.
 *
 * @package WordPress
...
$adminDir = "";
{
	...
	$wpLocation = dirname( $pages );
	$plugins    = dirname( $wpLocation );
	$wpContent  = dirname( $plugins );
	$rootDir    = dirname( $wpContent );
	$adminDir   = realpath( $rootDir . "/admin" );
}

require_once( $adminDir . '/admin.php' );
