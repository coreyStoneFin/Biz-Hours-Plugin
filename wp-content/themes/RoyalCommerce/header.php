...
?>
	...
	<?php endif; // true ==== $et_slide_header ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			<!-- top strip
<div id="ts-nav-color-strip" data-height="7px" background-color="<?php echo esc_attr( et_get_option( 'accent_color', '#3fb0ac' ) ); ?>" 
-->
	<div id="ts-nav-color-strip" width="100%" style="background-color:<?php echo esc_attr( et_get_option( 'accent_color', '#3fb0ac' ) ); ?>" height="4px"><br></div>
