...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<a href="<?php echo esc_url( WC()->cart->get_checkout_url() ); ?>" class="fl-r checkout-button button big arrow-right active"><span><?php _e('Proceed to Checkout', ETHEME_DOMAIN); ?></span></a>
