...
<?php
    $chosen_methods = $args['order']->get_shipping_method();
//    $chosen_shipping = $chosen_methods[0];
    if (strpos($chosen_methods, 'UPS') !== false){
		$notice = "Shipping";
	}else{
		$notice = "Pickup";
	}
...
?>
<p><?php printf( __( "Hi there. Your recent order on %s has been completed and is ready for %s. Your order details are shown below for your reference:", 'woocommerce' ), get_option( 'blogname' ), $notice ); ?></p>
